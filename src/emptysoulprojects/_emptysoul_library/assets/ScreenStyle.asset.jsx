...
const [screenStyleDesktop, setscreenStyleDesktop] = useState('');
  ...
  useEffect(() => {
    ...
    function checkResize(){
        ...
        (windowSize < '1200') ? setscreenStyleMobile(true) : setscreenStyleMobile(false);
        (windowSize < '576') ? setscreenStyleMobile_small(true) : setscreenStyleMobile_small(false);
        (windowSize < '1400') ? setscreenStyleDesktop(true) : setscreenStyleDesktop(false);
